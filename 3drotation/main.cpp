...
// Function to draw the rotated cube outline
void drawRotatedCubeOutline(float r, float g, float b, float angle) {
    float vertices[8][4] = {
        {-0.5f, -0.5f, -0.5f, 1.0f},
        {0.5f, -0.5f, -0.5f, 1.0f},
        {0.5f, 0.5f, -0.5f, 1.0f},
    ...
    // Apply rotation
    applyTransformation(vertices, 8, rotationMatrix);
...
void drawScene() {
    ...
    float angle = 45.0; // Angle in radians
    drawRotatedCubeOutline(1.0f, 0.0f, 0.0f, angle); // Red rotated cube
