...
// Function to draw the scaled cube outline
void drawScaledCubeOutline(float r, float g, float b, float scaleX, float scaleY, float scaleZ) {
    float vertices[8][4] = {
        {-0.5f, -0.5f, -0.5f, 1.0f},
        {0.5f, -0.5f, -0.5f, 1.0f},
        {0.5f, 0.5f, -0.5f, 1.0f},
    ...
    applyTransformation(vertices, 8, scalingMatrix);
...
void drawScene() {
    ...
    // Scaling factors
    float scaleX = 2.0f; // Scale factor along X-axis
    float scaleY = 2.0f; // Scale factor along Y-axis
    float scaleZ = 2.0f; // Scale factor along Z-axis
    drawScaledCubeOutline(1.0f, 0.0f, 0.0f, scaleX, scaleY, scaleZ); // Red scaled cube
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("3D Scaled Cube");
    initRendering();
